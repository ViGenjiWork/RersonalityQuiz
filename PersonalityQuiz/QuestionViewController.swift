...
//    MultiSwitches
    ...
    @IBOutlet var randedSlider: UISlider!
    ...
    var questions: [Question] = [
        ...
        Question(
            ...
            answers: [
                ...
                Answer(text: "I get i little nervous", type: .rabbit),
    ...
    @IBAction func singleAnswerButtonPressed(_ sender: UIButton) {
        ...
        switch sender {
        case singleButton1: answersChoosen.append(currentAnswers[0])
        case singleButton2: answersChoosen.append(currentAnswers[1])
        case singleButton3: answersChoosen.append(currentAnswers[2])
        case singleButton4: answersChoosen.append(currentAnswers[3])
        default: break
        }
    ...
    @IBAction func rangedAnswerButtonPressed() {
        let currentAnswers = questions[questionIndex].answers
        let index = Int(round(randedSlider.value * Float(currentAnswers.count - 1)))
    ...
    func updateRangedStack(using answers: [Answer]) {
        ...
        randedSlider.setValue(0.5, animated: false)
